  ...
  return language === "anglais" ? (
    ...
    >
      ...
      >
        ...
        {ipAddr === "Morocco" ? "IBYTRADE LTD" : "Iby Internet Ltd"}. We are
    ...
    >
      ...
      >
        Este sitio es propiedad de la empresa –{" "}
        {ipAddr === "Morocco" ? "IBYTRADE LTD" : "Iby Internet Ltd"}. Estamos
    ...
    >
      ...
      >
        ...
        {ipAddr === "Morocco" ? "IBYTRADE LTD" : "Iby Internet Ltd"}. Nous nous
