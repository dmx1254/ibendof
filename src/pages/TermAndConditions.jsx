...
const TermAndConditions = () => {
  ...
  return language === "anglais" ? (
    ...
    >
      ...
      >
        Este sitio es propiedad y está operado por{" "}
        ...
        aceptación afirmativa de estos términos y condiciones. La Compañía se
        reserva el derecho de cambiar el términos, condiciones y avisos bajo los
        cuales se encuentran sus sitios web y servicios Ofrecido. Usted es
        responsable de revisar regularmente estos términos y condiciones y
        cualquier término y condición adicional. Su uso continuado de los sitios
        web y servicios de la Compañía constituye su aceptación de todos dichos
    ...
    >
      ...
      >
        Ce site appartient et est exploité par{" "}
        {ipAddr === "Morocco" ? "IBYTRADE LIMITED" : "Iby Internet Ltd"}. Si
      ...
      >
        ...
        >
          IBYTRADE s’engage à rembourser les clients insatisfaits dans la mesure
          ...
          remboursement dans les cas suivants. Produits virtuels non reçus: Dans
          le cas où les produits virtuels n’ont pas été livrés au client dans le
          délai de livraison prévu, le client peut demander un remboursement.
          Double paiement: Dans le cas où le client a effectué un paiement
          répété pour une commande, il est prié de contacter le support afin
          d’être remboursé au plus vite. Pour toute raison autre que celles
